...
var trigger = function (opts, trigger) {
    ...
    assignClasses = function (dialog) {
        ...
        dialog.content[0].className = 'o-dialog__content o-dialog--' + dialog.opts.preset + '__content' + ' ' + dialog.opts.outerClasses + (dialog.opts.hasHeading ? '' : ' o-dialog__body');
    },
