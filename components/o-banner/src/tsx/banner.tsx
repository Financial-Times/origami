...
function isBannerSubmitButton(
	action: BannerSubmitButton | BannerLink
): action is BannerSubmitButton {
					...
					<div className="o-banner__actions">
						{primaryAction && !isBannerSubmitButton(primaryAction) && (
							<div className="o-banner__action">
								<a href="{primaryAction.url}" className="o-banner__button">
									{primaryAction.copy}
								</a>
							</div>
						)}
						{primaryAction && isBannerSubmitButton(primaryAction) && (
							<form
								className="o-banner__action"
								method={primaryAction.method}
								encType={primaryAction.encoding}
								action={primaryAction.action}
							>
								<input
									className="o-banner__button"
									type="submit"
									value={primaryAction.copy}
								/>
							</form>
						)}
						{secondaryAction && (
							<div className="o-banner__action o-banner__action--secondary">
								<a href="{secondaryAction.url}" className="o-banner__link">
