...
} as Meta<typeof ResponsiveOverflowTable>

export const TableWithResponsiveOverflow = {
	render: args => {
		useEffect(() => {
			javascript.init()
		})
		return (
			<ResponsiveOverflowTable {...args}>
				{baseTableContents}
...
export const ExpandingTable = {
	render: args => {
		...
		return (
			<ResponsiveOverflowTable minimumRows={args.minimumRows} {...args}>
