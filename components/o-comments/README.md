...
- [Markup](#markup)
	- [Stream](#stream)
	- [Redirection for illegal comment reporting](#redirection-for-illegal-comment-reporting)
	- [getCount](#getcount)
	- [auth](#auth)
...
- [Sass](#sass)
	- [Styling of Coral Talk iframe](#styling-of-coral-talk-iframe)
- [Migration](#migration)
- [Contact](#contact)
- [Licence](#licence)
...
Check out [how to include Origami components in your project](../../docs/legacy-o2-docs/technical-guide.md) to get started with `o-comments`.
