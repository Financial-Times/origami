...
import {FileInput as FileInputTsx} from '../src/tsx/components/input/FileInput';
import {
	FileInputJavaScript,
	fileInputJavaScriptSetup,
} from './FileInputJavaScript';
...
const meta: Meta<typeof FileInputTsx> = {
	title: 'o3-foundation/o3-input/file',
