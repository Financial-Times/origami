...
export const o3_color_use_case_link_text_hover = "#262a33";
export const o3_color_use_case_link_underline = "#0d7680";
export const o3_color_use_case_link_underline_hover = "#262a33";
export const o3_color_use_case_page_background = "#ffffff";
export const o3_color_use_case_body_text = "#1a1817";
...
export const o3_type_display_lg_font_family = "metric 2 VF, sans-serif"; // Use this style for large screens headlines in the main headers (toppers) of content pages, for prominent, large teasers or landing pages.
export const o3_type_display_lg_font_weight = "700"; // Use this style for large screens headlines in the main headers (toppers) of content pages, for prominent, large teasers or landing pages.
...
export const o3_type_display_lg_line_height = "3.5rem"; // Use this style for large screens headlines in the main headers (toppers) of content pages, for prominent, large teasers or landing pages.
export const o3_type_display_md_font_family = "metric 2 VF, sans-serif"; // Use this style for medium screens headlines in the main headers (toppers) of content pages, for prominent, large teasers or landing pages.
export const o3_type_display_md_font_weight = "700"; // Use this style for medium screens headlines in the main headers (toppers) of content pages, for prominent, large teasers or landing pages.
...
export const o3_type_display_md_line_height = "3rem"; // Use this style for medium screens headlines in the main headers (toppers) of content pages, for prominent, large teasers or landing pages.
export const o3_type_display_sm_font_family = "metric 2 VF, sans-serif"; // Use this style for small screens headlines in the main headers (toppers) of content pages, for prominent, large teasers or landing pages.
export const o3_type_display_sm_font_weight = "700"; // Use this style for small screens headlines in the main headers (toppers) of content pages, for prominent, large teasers or landing pages.
...
export const o3_type_display_sm_line_height = "2.5rem"; // Use this style for small screens headlines in the main headers (toppers) of content pages, for prominent, large teasers or landing pages.
export const o3_type_headline_lg_font_family = "metric 2 VF, sans-serif"; // Use this style for large screens headlines in standard-sized teasers and text only toppers (eg. Opinion and News).
export const o3_type_headline_lg_font_weight = "400"; // Use this style for large screens headlines in standard-sized teasers and text only toppers (eg. Opinion and News).
...
export const o3_type_headline_lg_line_height = "3rem"; // Use this style for large screens headlines in standard-sized teasers and text only toppers (eg. Opinion and News).
export const o3_type_headline_md_font_family = "metric 2 VF, sans-serif"; // Use this style for medium screens headlines in smaller teasers and text only toppers (eg. Opinion and News).
export const o3_type_headline_md_font_weight = "400"; // Use this style for medium screens headlines in smaller teasers and text only toppers (eg. Opinion and News).
...
export const o3_type_headline_md_line_height = "2.5rem"; // Use this style for medium screens headlines in smaller teasers and text only toppers (eg. Opinion and News).
export const o3_type_headline_sm_font_family = "metric 2 VF, sans-serif"; // Use this style for small screens headlines in smaller teasers and text only toppers (eg. Opinion and News).
export const o3_type_headline_sm_font_weight = "400"; // Use this style for small screens headlines in smaller teasers and text only toppers (eg. Opinion and News).
...
export const o3_type_headline_sm_line_height = "1.75rem"; // Use this style for small screens headlines in smaller teasers and text only toppers (eg. Opinion and News).
...
export const o3_type_body_content_base_font_family = "financier text VF, serif"; // Use this style only for the body copy of content pages, such as articles, live news and other content experience page.
export const o3_type_body_content_base_font_weight = "1"; // Use this style only for the body copy of content pages, such as articles, live news and other content experience page.
export const o3_type_body_content_base_font_size = "1.5rem"; // Use this style only for the body copy of content pages, such as articles, live news and other content experience page.
...
export const o3_type_body_content_highlight_font_family =
  "financier text VF, serif"; // Use this style only for the body copy of content pages, such as articles, live news and other content experience page.
export const o3_type_body_content_highlight_font_size = "1.5rem"; // Use this style only for the body copy of content pages, such as articles, live news and other content experience page.
...
export const o3_type_body_content_highlight_font_weight = "600"; // Use this style only for the body copy of content pages, such as articles, live news and other content experience page.
export const o3_type_body_content_emphasis_font_family =
  "financier text VF, serif"; // Use this style only for the body copy of content pages, such as articles, live news and other content experience page.
export const o3_type_body_content_emphasis_font_weight = "1"; // Use this style only for the body copy of content pages, such as articles, live news and other content experience page.
export const o3_type_body_content_emphasis_font_size = "1.5rem"; // Use this style only for the body copy of content pages, such as articles, live news and other content experience page.
...
export const o3_font_family_financier_text = "financier text VF, serif";
