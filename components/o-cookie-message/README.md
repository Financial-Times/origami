...
Check out [how to include Origami components in your project](../../docs/legacy-o2-docs/technical-guide.md) to get started with `o-cookie-message`.
...
```js
import oCookieMessage from '@financial-times/o-cookie-message/main';
