...
export const Dynamic: StoryFn = args => {
	useEffect(() => {
		const oAutoCompleteElement = document.getElementById(
			'#o-autocomplete-demo'
		);
		console.log(oAutoCompleteElement);
		oAutoComplete.init(oAutoCompleteElement, {source: 'customSuggestions'});
	}, []);
		...
		<form data-o-component="o-forms">
			<div className="o-forms-field">
				...
				<span className="o-forms-input o-forms-input--text">
					<span
						id="o-autocomplete-demo"
						data-o-component="o-autocomplete"
						data-o-autocomplete-default-value="United Kingdom"
					...
					<span role="alert" className="o-forms-input__error">
