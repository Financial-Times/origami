		...
		<div className="o-message__container">
			<div className="o-message__content">
				...
				<div className="o-message__actions">
					<a href={primaryAction.url} className="o-message__actions__primary" target={primaryAction.openInNewWindow ? '_blank' : '_self'} >{primaryAction.text}</a>
					{state !== 'feedback' && <a href={secondaryAction.url} className="o-message__actions__secondary" target={secondaryAction.openInNewWindow ? '_blank' : '_self'}>{secondaryAction.text}</a>}
				</div>
			</div>
		</div>
	</div>
