...
Check out [how to include Origami components in your project](../../docs/legacy-o2-docs/technical-guide.md) to get started with `o-forms`.
...
For text-like input types where `o-forms` does not provide a specific modifier class the `o-forms-input--text` modifier may be used. [_See more examples in the Origami Storybook._](https://o2-core.origami.ft.com/?path=/story/maintained-o-forms-text-box--optional-text)
...
[_See radio buttons in Storybook_](https://o2-core.origami.ft.com/?path=/story/maintained-o-forms-radio-buttons--radio-button)
