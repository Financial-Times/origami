	...
	<div class="o-forms-field" role="group" aria-labelledby="date-group-title">
		...
		<span class="o-forms-input o-forms-input--date">
			<label for="date">
				...
				<input class="o-forms-input__day-part" id="date" type="text" name="date" value="" required>
			</label>
			<label for="date1">
				<span class="o-forms-input__label">MM</span>
				<input class="o-forms-input__month-part" id="date1" type="text" name="date" value="" required>
			</label>
			<label for="date2">
				<span class="o-forms-input__label">YYYY</span>
				<input class="o-forms-input__year-part" id="date2" type="text" name="date" value="" required>
			</label>
		</span>
	</div>
