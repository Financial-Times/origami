...
Check out [how to include Origami components in your project](https://origami.ft.com/docs/components/#including-components-in-your-project) to get started with `o-example`.

## Behaviour

`o-example` Behaviour description.
...
```html
<div data-o-component="o-example" class='o-example'>
</div>
```
...
Use `@include oExample()` to include styles for all `o-example` features.

```scss
@import "@financial-times/o-example";
...
JavaScript is initialised automatically for [Origami Build Service](https://www.ft.com/__origami/service/build/v2/) users. If your project is using a manual build process, [initialise  `o-example` manually](https://origami.ft.com/docs/tutorials/manual-build/).

For example call the `init` method to initialise all `o-example` instances in the document:
...
Or pass an element to initialise a specific `o-example` instance:

```js
import oExample from 'o-example';
const oExampleElement = document.getElementById('#my-o-example-element');
oExample.init(oExampleElement);
```
...
## Contact
If you have any questions or comments about this component, or need help using it, please either [raise an issue](https://github.com/Financial-Times/origami/issues/new?labels=o-example,components), visit [#origami-support](https://financialtimes.slack.com/messages/#origami-support/) or email [origami.support@ft.com](mailto:origami.support@ft.com).
