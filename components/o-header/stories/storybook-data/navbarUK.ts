			...
			meganav: [
				...
				},
				{
					...
					data: [
						...
						{
							label:
								'Liam Fox’s trade department cancels Brexit briefings with business',
						...
						{
							label:
								'Northern Ireland is warned of ‘grave’ impact of a no-deal Brexit',
			...
			meganav: [
				...
				},
				{
					...
					data: [
						...
						{
							label:
								'UK attorney-general makes last-ditch bid to end backstop impasse',
						...
						{
							label:
								'Barclays banker unwilling to ‘take a hit’ to save top execs',
			...
			meganav: [
				...
				},
				{
					...
					data: [
						{
							label:
								'BoE sets up facility to buffer banks in event of chaotic Brexit',
						...
						{
							label:
								'Stocks surge but many investors sit it out on the sidelines',
			...
			meganav: [
				...
				},
				{
					...
					data: [
						...
						{
							label:
								'My First Million: Victoria Robertshaw, founder Keelham Farm Shop',
