...
@include oLabels(
	$opts: (
			// standard label sizes to outpu
			// e.g. .o-labels--bi
		"sizes": ("big"),
			// standard label states to outpu
			// e.g. .o-labels--content-commercia
		"states": ("content-commercial", "content-premium"),
			// indicator label labels to outpu
			// .o-labels-indicato
		"indicators":
			(
					// indicator label statuses to outpu
					// .o-labels-indicator--liv
				"status": ("live"),
					// whether to output the indicator label inverse styl
					// .o-labels-indicator--invers
				"inverse": true
			),
			// output the timestamp label labe
			// .o-labels-timestam
		"timestamp":
			(
					// whether to output the timestamp label inverse styl
					// .o-labels-timestamp--invers
				"inverse": true
			),
	)
);
