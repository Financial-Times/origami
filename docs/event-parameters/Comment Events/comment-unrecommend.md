...
A comment:unrecommend event is sent on any click that would result in the unrecommending of a comment (that was previous recommended).

---------

These are the documented parameters for a comment:unrecommend event.
