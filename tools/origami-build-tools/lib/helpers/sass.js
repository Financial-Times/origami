...
if (windows64bit) {
	module.exports = '../../exe/sass-windows-x64';
} else if (windows32bit) {
	module.exports = '../../exe/sass-windows-ia32';
} else if (mac) {
	module.exports = '../../exe/sass-macos-x64';
} else if (linux64bit) {
	module.exports = '../../exe/sass-linux-x64';
} else if (linux32bit) {
	module.exports = '../../exe/sass-linux-ia32';
} else {
	throw new Error(
