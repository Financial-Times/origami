...
if (!await fileExists('./origami.json')) {
    console.log(`No origami.json file found. To make this an Origami component, create a file at ${path.join(process.cwd(), '/origami.json')} following the format defined at: https://origami.ft.com/docs/manifests/origami-json/`);
} else {
    await origamiJson(config)
}
