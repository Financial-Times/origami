...
<aside><a href="https://codepen.io/ft-origami/pen/GBXgZa" rel="noreferrer noopener" target="_blank" class="o-typography-link">Show me the CodePen</a></aside>
...
We can find the markup for the <a href="https://o2-core.origami.ft.com/?path=/story/components-o-table-row-stripes--row-stripes&globals=backgrounds:!undefined">striped variation of o-table in Storybook</a>, and copy that <abbr title="Hypertext Markup Language">HTML</abbr> into our work from there.
