...
Origami 3 components have a Figma project for each brand. This can be found in the [Origami for Everyone](https://www.figma.com/files/938480807921629744/team/1237702133754424766) group in Figma.

As each component has an equivalent in Figma, each story has a link to the Figma component via the Design tab in Storybook.
