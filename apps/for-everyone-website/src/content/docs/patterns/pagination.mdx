...
We recommend using Origami components which provide this pagination functionality by default.

We show no more than 7 pages at a time. When there are more than 7 pages, hide more pages behind the pagination ellipsis in the following way. Given:
