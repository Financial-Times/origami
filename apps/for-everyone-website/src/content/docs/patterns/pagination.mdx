...
export function Preview ({component: Component, componentProps} = props) {
    ...
    return <>
     ...
     <a style="display: inline-block; margin: var(--o3-spacing-2xs) 0;" href={`https://o3.origami.ft.com?path=/story/core-o3-button--pagination&args=theme:${componentProps.theme}`}>Open in StoryBook</a> | <a style="display: inline-block; margin: var(--o3-spacing-2xs) 0;" href="https://www.figma.com/file/nSD9N3r4MiMpv9pA6F4Dpy/Pagination?type=design&node-id=5463-1742&mode=design">Open in Figma</a>
        <details>
