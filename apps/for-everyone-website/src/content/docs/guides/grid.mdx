...
<Aside type="caution">Our new grid guidelines are experimental and open to change without notice. Please contact the Origami team before using.</Aside>
...
This page covers the design and behaviour of grids. For technical details, please see the

<a
	href={`https://o3.origami.ft.com/?path=/docs/${props.brand}-o3-foundation-o3-grid-readme--jsx-documentation`}>
	technical documentation in Storybook
</a>
.
Note that the previous version of Origami (o2) uses a different grid system, for
this [see o-grid](https://o2-core.origami.ft.com/index.html?path=/docs/components-o-grid-readme--docs&globals=backgrounds:!undefined#grid-dimensions).
