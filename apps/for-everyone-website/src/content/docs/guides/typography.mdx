...
<PreviewFrame html={`<span class="o3-type-body-base">Make <a href="#">sense of</a> it all.</span>`} mark={`a href`} />

Here is another example which shows a link within `body-content-base`.
<PreviewFrame html={`<span class="o3-type-body-content-base">Make <a href="#">sense of</a> it all.</span>`} mark={`a href`} />
