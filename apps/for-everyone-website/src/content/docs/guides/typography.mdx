...
We do not recommend the direct use of our typographic scale within projects. Instead use a [usecase](#Style-Usecases), which defines family, scale, weight, and style as one token for specific scenarios.
...
Font weight can be used to express hierarchy or urgency of information. As with our typographic scale, we do not recommend the direct use of our font weight values within projects. Instead apply a [typography usecase](#Style-Usecases).
...
<BrandedContent brands="core, professional, sustainable-views, whitelabel">
In addition to these general styles, Origami provides typography components which use these. For example the [display heading component](#headings) combines all three [display sizes](#display) at different breakpoints for a responsive heading.
</BrandedContent>
...
The link style can be applied inline (within a paragraph or body text) or standalone. The inline links inherits the text properties of the body it is in.
...
<PreviewFrame html={`<span class="o3-typography-use-case-body-base">Make <a href="#">sense of</a> it all.</span>`} mark={`a href`} />

Here is another example which shows a link within `body-content-base`.
<PreviewFrame html={`<span class="o3-typography-use-case-body-content-base">Make <a href="#">sense of</a> it all.</span>`} mark={`a href`} />

## UI Components

<BrandedContent brands="core, professional, sustainable-views, whitelabel">
	User interface (UI) typography components apply typography usecases for a specific context. They are intended for all design elements except
...
<BrandedContent brands="core, professional, sustainable-views, whitelabel">
	...
	<PreviewFrame html={`<span class="o3-typography-use-case-body-content-base">Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet earum libero at voluptatum <strong>highlight</strong> illum facere totam architecto eum porro exercitationem, ea, <em>emphasis</em> accusamus quia? Repellat beatae similique ab? Reprehenderit, ullam quae?`} mark={`o3-typography-use-case-body-content-base`} />

	### Drop cap

	Use for stylistic emphasis on the first letter of an article.

	<PreviewFrame html={`<span class="o3-typography-use-case-body-content-base o3-editorial-typography-drop-cap">Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet earum libero at voluptatum <strong>highlight</strong> illum facere totam architecto eum porro exercitationem, ea, <em>emphasis</em> accusamus quia? Repellat beatae similique ab? Reprehenderit, ullam quae?`} mark={`o3-editorial-typography-drop-cap`} />
