...
import {default as PlacementOrderGuidlines} from '../../../../components/form/Guideline-placement-order.astro'
import {default as RequiredOptionalInput} from '../../../../components/form/Guideline-required-optional.astro'
...
<Tip sourcesEnabled={true}>
	...
	<Fragment slot="tip-sources">
		<a href="https://www.lukew.com/ff/entry.asp?680">
			Luke W: Web Form Design: Filling in the Blanks
		</a>
		<span> |</span>
		<a href="https://www.nngroup.com/articles/web-form-design/">
...
<Tip>
	<p slot="tip-content">In order to reduce cognitive load for the user, we decided to omit the “required” label. This
		makes for easier scanning when there are multiple inputs with less visual disruptions.</p>
</Tip>
...
--Placeholder grouping dos n donts--
...
<Tip>
	<ol slot="tip-content">
		<li>
			Validation on each keystroke would create unnecessary error feedback noise while the user is typing.
		</li>
		<li>
			Presenting errors too quick is considered a hostile pattern
		</li>
		<li>
			Changing the component state as they are interacting with it might feel unexpected for them. That’s why we
			perform validation when the user is not interacting with the component anymore.
		</li>
	</ol>
</Tip>
...
--placeholder page level validation demo--
