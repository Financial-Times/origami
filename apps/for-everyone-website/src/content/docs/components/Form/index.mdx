...
import {default as PlacementOrderGuidlines} from '../../../../components/form/guidelines/Placement-order.astro';
import {default as RequiredOptionalInput} from '../../../../components/form/guidelines/Required-optional.astro';
import {default as LabelsGrouping} from '../../../../components/form/guidelines/Labels-grouping.astro';
import {default as FormSubmission} from '../../../../components/form/guidelines/Form-submission.astro';
import {default as InputValidation} from '../../../../components/form/examples/Input-validation.astro';
import {default as ErrorSummary} from '../../../../components/form/examples/Page-level-validation.astro';
import {default as DisabledStates} from '../../../../components/form/examples/Disabled-state.astro';

import '@financial-times/o3-form/css/whitelabel.css';

<BrandedContent brands="core,internal,professional,sustainable-views">
	Currently we have a limited brand support for form components. We are working on expanding this to all brands. For now, please refer to the [whitelabel form components](/whitelabel/components/form) for more information.
</BrandedContent>
