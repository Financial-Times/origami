...
Neutral is a theme that is only available on the core brand. It is used for buttons that are not the primary action on a page, but are still important.

<div data-o3-theme="core">
	<Preview
...
It is available in either primary or ghost button types. It is not supported with secondary for the moment.
