...
Neutral is a theme that is only available on the Core or Professional brand. It is used for primary action buttons like the Ask FT on the homepage. It is available in either primary or ghost button types. It is not supported with secondary for the moment.
