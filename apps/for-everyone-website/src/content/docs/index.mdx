...
template: splash
hero:
  tagline: Optimise your workflow with all new "o3" components and Figma integrations. Origami For Everyone will support the FT to create differentiated products, targeting different audiences, by scaling Origami to support more brands and platforms.
  image:
    file: ../../assets/for-everyone-logo.svg
  actions:
    - text: Get started with o3 components
      link: ./components/
      icon: right-arrow
      variant: primary
    - text: Learn More
