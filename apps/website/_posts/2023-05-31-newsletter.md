...
We're excited about Origami for Everyone, a project that aims to address these challenges and make the Origami design system more integral to the delivery of every user-facing product that FT delivers. The project has three main goals: universal usability, designer-developer collaboration, and multi-platform compatibility.
