...
<Guideline summary="Full-width usage" do={true}>
    ...
    <Example slot="examples" do={true}>
    	![](/assets/images/components/buttons/usage-full-width-do.svg)
    </Example>

    <Example slot="examples" do={false}>
    	![](/assets/images/components/buttons/usage-full-width-dont.svg)
    </Example>
...
<Guideline summary="Only one primary button per product area" do={true}>
    ...
    <Example slot="examples" do={true}>
    	![](/assets/images/components/buttons/usage-only-one-primary-button-do.svg)
    </Example>

    <Example slot="examples" do={false}>
    	![](/assets/images/components/buttons/usage-only-one-primary-button-dont.svg)
    </Example>
...
<Guideline summary="Icons in button should be on the left" do={true}>
    ...
    <Example slot="examples" do={true}>
    	![](/assets/images/components/buttons/usage-icons-placement-do.svg)
    </Example>

    <Example slot="examples" do={false}>
    	![](/assets/images/components/buttons/usage-icons-placement-dont.svg)
    </Example>
...
<Guideline summary="Group related buttons where it helps the user." do={true}>
	<Example slot="examples" do={true}>
		![](/assets/images/components/buttons/usage-group-releated-buttons-do.svg)
	</Example>
</Guideline>
...
<Guideline summary="Limit to 6 buttons per group" do={true}>
    ...
    <Example slot="examples" do={true}>
    	![](/assets/images/components/buttons/usage-limit-6-buttons-group-do.svg)
    </Example>

    <Example slot="examples" do={false}>
    	![](/assets/images/components/buttons/usage-limit-6-buttons-group-dont.svg)
    </Example>
...
<Guideline summary="Use clear, action-driven language (e.g. 'Share', 'Download')" do={true}>
	<Example slot="examples" do={true}>
    	![](/assets/images/components/buttons/label-guidance-action-driven-do.svg)
    </Example>

    <Example slot="examples" do={false}>
    	![](/assets/images/components/buttons/label-guidance-action-driven-dont.svg)
    </Example>
...
<Guideline summary="Do not use filler words, punctuation or unnecessary articles ('the', 'a')" do={true}>
	<Example slot="examples" do={true}>
    	![](/assets/images/components/buttons/label-guidance-filler-words-do.svg)
    </Example>

    <Example slot="examples" do={false}>
    	![](/assets/images/components/buttons/label-guidance-filler-words-dont.svg)
    </Example>
...
<Guideline summary="Write labels in sentence case" do={true}>
	<Example slot="examples" do={true}>
    	![](/assets/images/components/buttons/label-guidance-sentence-case-do.svg)
    </Example>

    <Example slot="examples" do={false}>
    	![](/assets/images/components/buttons/label-guidance-sentence-case-dont.svg)
    </Example>

    <Example slot="examples" do={false}>
    	![](/assets/images/components/buttons/label-guidance-sentence-case-dont-too.svg)
    </Example>
...
<Guideline summary="Ensure contrast meets WCAG standards" do={true}>
    ...
    <Example slot="examples" do={false}>
    	![](/assets/images/components/buttons/accessibility-considerations-contrast-dont.svg)
    </Example>
...
<Guideline summary="All buttons must have at least a 44px target size" do={true}>
	<Example slot="examples" do={true}>
    	![](/assets/images/components/buttons/accessibility-considerations-44pixels-target-size-do.svg)
    </Example>
