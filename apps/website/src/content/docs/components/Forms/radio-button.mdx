...
import {default as RadioButtonSelectionError} from '../../../../components/forms/examples/Radio-button-selection-error.astro';
...
<RadioButtonSelectionError brand={props.brand} />
