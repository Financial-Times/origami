...
<Aside type="caution">
	Our new grid guidelines are experimental and open to change without notice.
	Please contact the Origami team before using.
</Aside>
...
This page covers the design and behaviour of grids. For technical details, please see the <a href={`https://o3.origami.ft.com/?path=/docs/${props.brand}-o3-foundation-o3-grid-readme--jsx-documentation`}>technical documentation in Storybook</a>.
Note that the previous version of Origami (o2) uses a different grid system, for
this [see o-grid](https://o2-core.origami.ft.com/index.html?path=/docs/maintained-o-grid-readme--docs&globals=backgrounds:!undefined).
We recommend following the below design guidelines for any new projects.
...
- **Medium (M)**: 740-1023px. For tablets.
- **Large (L)**: 1024-1439px. For large tablets and small desktops.
- **Extra Large (XL)**: 1440px and above. For desktop screens.
...
Our grid is fluid, it uses 100% of the screen’s width until the max width of 1312px is reached. After this, the margins grow to fill the screen. This allows for maximum use of screen real estate, in complex screens and readability of page content in large and high-definition screens.
