...
- A dependency on [o-normailse](http://github.com/financial-times/o-normailse) v1 has been introduced. This is not likely to introduce any conflicts as it is only v1.
