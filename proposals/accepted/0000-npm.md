...
- Our documentation assumes bower but some people are already using npm, which can lead to confusion and wasted time. By becoming npm only our documentation becomes more simple.
