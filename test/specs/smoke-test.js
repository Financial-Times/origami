...
describe('smoke-tests (./modal.js)', function () {
    ...
    afterEach(function () {
        el.remove();
        tpl && tpl.remove();
        Array.prototype.forEach.call(document.querySelectorAll('.o-modal'), function (el) {
    ...
    describe('opening and closing', function () {
        ...
        it('should remove all traces on close', function (done) {
            Modal.listen();
        ...
        it('should be closable in many different ways', function (done) {
            spyOn(Modal.prototype, 'close');
            Modal.listen();
        ...
        it('should be possible to open and close imperatively', function (done) {
            var mod = new Modal({
                src: testContent,
