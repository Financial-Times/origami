...
A comment:ban event is sent on any click to the 'ban user' button (to ban a user from commenting)
- This is funcionality only avaiable to FT Admin

---------

These are the documented parameters for a comment:ban event.
