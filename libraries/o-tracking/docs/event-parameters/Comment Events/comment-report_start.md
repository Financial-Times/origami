# comment:report_start

A comment:report_start event is sent on all clicks that open the overlay to report on a comment.

---------

These are the documented parameters for a comment:report_start event.
