...
describe("Delegate", () => {
	...
	it("Complex selectors are supported", () => {
		...
		delegate.on(
			"click",
			"div.delegate-test-clickable, div[id=another-delegate-test-clickable]",
			spyA
		)
		delegate.on(
			"click",
	...
	it("Can be to bound to a different DOM element", () => {
		...
		const element = document.getElementById(
			"element-in-container2-test-clickable"
		)
