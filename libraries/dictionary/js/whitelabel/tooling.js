export default {
	...
	"o3-color-use-case-link-underline": {
		"shortName": "@",
		"value": "#b3b3b3",
		"originalValue": "{o3.color.palette.black-30}",
		"type": "color",
		"path": [
				"o3",
				"color",
	...
	"_o3-button-ghost-standard-active-active": {
		"shortName": "active",
		"value": "#ffffff",
		"originalValue": "#ffffff00",
		"type": "color",
		...
		"css": "--_o3-button-ghost-standard-active-active",
		"figma": "o3/button/ghost/standard/active/active"
},
	"o3-spacing-5xs": {
		"shortName": "5xs",
		"value": "4px",
